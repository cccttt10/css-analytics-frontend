...
# CSS Analytics API Service

CSS Analytics offers a RESTful, JSON-based service.

---

## GET https://css-analytics.herokuapp.com/getCssAnalytics?url=google.com

Replace `google.com` with any url. The service will scrape stylesheets from the given url and return analytics JSON.
